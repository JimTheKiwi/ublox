...
* `publish/mon/io`: Topic `~monio`
* `publish/mon/msgpp`: Topic `~monmsgpp`
* `publish/mon/rxbuf`: Topic `~monrxbuf`
* `publish/mon/smgr`: Topic `~monsmgr`
* `publish/mon/txbuf`: Topic `~montxbuf`
